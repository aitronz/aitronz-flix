...
| Frontend       | [aitronz-flix](https://docs.undi.rest/instances)                | [source code](https://github.com/sussy-code/smov)        |
...
## Updating a aitronz-flix Instance
To update a aitronz-flix instance you can type the below commands into a terminal at the root of your project.
```bash
...
git commit -m "Update aitronz-flix instance (merge upstream/main)"
git push  # Push to YOUR repository
```


## Contact Me
**Email:** *[dev@aitronz-flix.lol](mailto:dev@aitronz-flix.lol)* 
